...
class MainActivity : AppCompatActivity() {
    ...
    val API: String = "68a0e382d4a2139a1fc1980668659766"
    ...
    inner class weatherTask(): AsyncTask<String,Void,String>() {
        ...
        override fun doInBackground(vararg p0: String?): String? {
            var response:String?
            try {
                response = URL("https://api.openweathermap.org/data/2.5/weather?q=$CITY&units=metric&apiid=&API")
        ...
        override fun onPostExecute(result: String?) {
            ...
            try {
                ...
                val windSeed = wind.getString("speed")
                ...
                findViewById<TextView>(R.id.wind).text = windSeed
